...
OBJECTS += ./mbed-os/features/cellular/framework/targets/TELIT/ME310/TELIT_ME310.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/TELIT/ME310/TELIT_ME310_CellularContext.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/TELIT/ME310/TELIT_ME310_CellularNetwork.o
OBJECTS += ./mbed-os/features/cellular/framework/targets/TELIT/ME310/TELIT_ME310_CellularStack.o
...
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/aes_alt_stm32l4.o
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/ccm_alt.o
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/cryp_stm32.o
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/gcm_alt.o
OBJECTS += ./mbed-os/features/mbedtls/targets/TARGET_STM/hash_stm32.o
...
OBJECTS += ./mbed-os/features/nanostack/mbed-mesh-api/source/WisunBorderRouter.o
...
OBJECTS += ./mbed-os/features/nanostack/nanostack-hal-mbed-cmsis-rtos/ns_file_system_api.o
...
OBJECTS += ./mbed-os/features/nanostack/sal-stack-nanostack/source/6LoWPAN/ws/ws_pae_key_storage.o
...
OBJECTS += ./mbed-os/features/nanostack/sal-stack-nanostack/source/6LoWPAN/ws/ws_pae_time.o
...
OBJECTS += ./mbed-os/features/nanostack/sal-stack-nanostack/source/MAC/IEEE802_15_4/mac_cca_threshold.o
...
INCLUDE_PATHS += -I.././mbed-os/features/cellular/framework/targets/TELIT/ME310
...
INCLUDE_PATHS += -I../c:/Users/yuto/Mbed Programs/dragon-robot/mbed-os
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1600846669.705332
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1600846669.705332
...
ASM_FLAGS += -I..\mbed-os\features\cellular\framework\targets\TELIT\ME310
...
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F3
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F3\TARGET_STM32F303x8
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F3\TARGET_STM32F303x8\TARGET_NUCLEO_F303K8
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F3\TARGET_STM32F303x8\device
ASM_FLAGS += -I..\mbed-os\targets\TARGET_STM\TARGET_STM32F3\device
ASM_FLAGS += -Ic:\Users\yuto\Mbed Programs\dragon-robot\mbed-os
ASM_FLAGS += -include
